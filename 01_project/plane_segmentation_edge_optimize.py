...
# for iii in range(2,3):
    ...
    # 1. 筛选出在两个平面之间的点
    points_between_p3_i,points_beside = select_points_between_planes(points_beside, center_i, center_i_p3, plane_normals[mmm])
    points_between_p3_j,points_beside = select_points_between_planes(points_beside, center_j, center_j_p3, plane_normals[nnn])
    ...
    # 1. 筛选出在两个平面之间的点
    points_between_p4_i,points_beside = select_points_between_planes(points_beside, center_i_p3, center_i_p4, plane_normals[mmm])
    points_between_p4_j,points_beside = select_points_between_planes(points_beside, center_j_p3, center_j_p4, plane_normals[nnn])
    ...
    # proj_pcd_p4_unfilter.paint_uniform_color([0, 0, 1])  # 蓝色
    ...
    center_i_p5 = center_i + ((rd + rj)/2) * (plane_normals[mmm]) * dist_dir_i
    center_j_p5 = center_j + ((rd + rj)/2) * (plane_normals[nnn]) * dist_dir_j

    points_between_p5_i,points_beside = select_points_between_planes(points_beside, center_i_p4, center_i_p5, plane_normals[mmm])
    points_between_p5_j,points_beside = select_points_between_planes(points_beside, center_j_p4, center_j_p5, plane_normals[nnn])
